...
describe('/course', () => {
    ...
    it(`should'nt create corse with incorrect input data`, () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(src_1.app)
            .post('/courses')
            .send({ title: '' })
    ...
    it(`should create corse with correct input data`, () => __awaiter(void 0, void 0, void 0, function* () {
    ...
    it(`should'nt update corse with incorrect input data`, () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(src_1.app)
    ...
    it(`should'nt update corse that not exist`, () => __awaiter(void 0, void 0, void 0, function* () {
        yield (0, supertest_1.default)(src_1.app)
            .put(`/courses/` + -100)
