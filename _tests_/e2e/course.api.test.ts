...
it(`should'nt create corse with incorrect input data`, async () => {
    await request(app)
        .post('/courses')
        .send({ title: ''})
...
it(`should create corse with correct input data`, async () => {
...
it(`should'nt update corse with incorrect input data`, async () => {
    await request(app)
  ...
  it(`should'nt update corse that not exist`, async () => {
    await request(app)
          .put(`/courses/` + -100)
